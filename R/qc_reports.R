...
create_qc_reports <- function(samplesheet = NULL,
        ...
        cat("                                                  style = function(value) {bar_style(length = value/100)}),", "\n", sep = "")
        cat("                         \"% 300 ~ 350\" = colDef(filterMethod = JS(\"filterMinValue\"), filterInput = JS(\"rangeFilter\"),", "\n", sep = "")
        cat("                                                  style = function(value) {bar_style(length = value/100)}),", "\n", sep = "")
        cat("                         \"% 350 ~ 400\" = colDef(filterMethod = JS(\"filterMinValue\"), filterInput = JS(\"rangeFilter\"),", "\n", sep = "")
        cat("                                                  style = function(value) {bar_style(length = value/100)}),", "\n", sep = "")
